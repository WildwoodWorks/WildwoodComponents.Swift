...
enum TestScreen: String, CaseIterable, Identifiable {
    ...
    var icon: String {
        ...
        case .aiFlow: return "point.3.connected.trianglepath.dotted"
        ...
        case .registrationSubscription: return "cart"
        ...
        case .attribution: return "antenna.radiowaves.left.and.right"
